const createWeek = (weekNumber, date, isOff = false) => ({
  weekNumber,
...
export const GUEST_LECTURER_PAGE_SUMMARY =
  "If you unlocked this page in Studio, choose the weeks that could work for you and share your details. Rushi will review your EOI and follow up if there is a fit.";
...
export const GUEST_LECTURER_WEEKS = [
  createWeek(1, "2026-06-05"),
  createWeek(2, "2026-06-12"),
  createWeek(3, "2026-06-19"),
  createWeek(4, "2026-06-26"),
  createWeek(5, "2026-07-03"),
  createWeek(6, "2026-07-10", true),
  createWeek(7, "2026-07-17"),
  createWeek(8, "2026-07-24"),
  createWeek(9, "2026-07-31"),
  createWeek(10, "2026-08-07"),
];
